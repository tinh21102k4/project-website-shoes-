            ...
            <div class="container text-center text-md-start mt-5">
                <div class="row mt-3">
                    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                        ...
                        <p><i class="fas fa-home me-3"></i> Mỹ Đình 2 , Hà Nội</p>
                        <p>
                            <i class="fas fa-envelope me-3"></i>
                            haduytinh21102004@gmail.com
                        </p>
                        <p><i class="fas fa-phone me-3"></i> +84 394562068</p>
                    </div>
        ...
        <section class=" justify-content-center justify-content-lg-between p-4 border-top"
            ...
            <div class="text-center me-5 d-none d-lg-block">
                <span class="text-center text-white">© 2024 Bản quyền thuộc về:
                    <a class="text-white" href="/">&ensp; Hà Duy Tình PH43108</a>
                </span>
            </div>
        </section>
    </footer>
